...
<ParamField path="voice_id" type="string"> 
    The name of the voice to be used. Provide the voice_id as a string. Allowed values are: <ul> <li>amar_indian_male</li> <li>anuja_indian_male</li> <li>vijay_indian_male</li> <li>janhvi_professional_female</li> <li>govind_indian_male</li> <li>prabhu_indian_male</li> <li>sarika_north_indian_female</li> <li>rakesh_north_indian_male</li> <li>chandralekha_bengal_female</li> <li>rustom_bengal_male</li> <li>ishwara_south_indian_male</li> <li>suresh_indian_male</li> <li>anamika_whisper_female</li> <li>joy_sleepy_male</li> <li>willian_angry_male</li> <li>mehul_cheerful_male</li> </ul> 
</ParamField> 

<ParamField path="add_wav_header" type="bool"> 
    Whether a WAV header should be included in the output. Default is true. 
</ParamField> 

<ParamField path="sample_rate" type="int"> 
    The sample rate for the output audio. Default is 24000. 
</ParamField> 

<ParamField path="language" type="string"> 
    The language of the text to be converted to speech. Allowed values are: <ul> <li>'en' - for English</li> <li>'hi' - for Hindi</li> </ul> Providing the correct language code improves the quality of the audio output. Both 'hi' and 'en' can handle Hinglish, but specifying the language code is recommended. 
</ParamField> 
