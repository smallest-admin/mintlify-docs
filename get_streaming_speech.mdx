...
<ParamField path="get_end_of_response_token" type="bool">
  Specifies whether you wish to receive end of response token to indicate that all the data corresponding to this payload has been sent. 
  You will receive the reponse at the end as a string which will be "<END>".
</ParamField>
